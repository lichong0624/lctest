        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="layui-this"><a href="/?c=Admin&a=Index">管理员列表</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
                ...
                <?php if (isset($data)&&!empty($data)) {?>
                    ...
                    <?php foreach ($data as $k => $v){?>
                        <tr>
                            ...
                            <td>
                                <?php if($v['sex'] == 0) echo '未知';?>
                                <?php if($v['sex'] == 1) echo '男';?>
                                <?php if($v['sex'] == 2) echo '女';?>
                            </td>
                            <td>
                                <?php echo $v['mobile']?>
<!--                                <a href="/?c=Admin&a=Dele&id=--><?php //echo $v['id'];?><!--"><button class="layui-btn">删除</button></a>-->
                            </td>
                        </tr>
                    <?php }?>
                    </tbody>
