...
class Q_Json
{
     ...
     * objects. See {@link Q_Json_Decoder::decode()} for details.
     * @return mixed
     */
    public static function decode($encodedValue, $objectDecodeType = Q_Json::TYPE_ARRAY)
    {
        if (function_exists('json_decode') && self::$useBuiltinEncoderDecoder !== true) {
            return json_decode($encodedValue, $objectDecodeType);
        }

        return Q_Json_Decoder::decode($encodedValue, $objectDecodeType);
    }
    ...
    public static function encode($valueToEncode, $cycleCheck = false, $options = array())
    {
        ...
        return Q_Json_Encoder::encode($valueToEncode, $cycleCheck, $options);
    }
     ...
     *
     * Throws a Q_Exception if the input not a XML formatted string.
     *
     * @static
     * @access public
    ...
    public static function fromXml ($xmlStringContents, $ignoreXmlAttributes=true) {
        ...
        if ($simpleXmlElementObject == null) {
            throw new Q_Exception('Function fromXml was called with an invalid XML formatted string.');
        ...
        // Convert the PHP array to JSON using Q_Json encode method.
     ...
     *
     * Throws a Q_Exception if the XML tree is deeper than the allowed limit.
     *
     * @static
     * @access protected
