...
class Q_Json_Encoder
{
     ...
     * @param $value object
     * @return string
     * @throws Q_Exception If recursive checks are enabled and the object has been serialized previously
     */
    ...
    public static function encodeClass($className, $package = '')
    {
        ...
        if (! $cls->isInstantiable()) {
            throw new Q_Exception("$className must be instantiable");
        }
